...
describe('db', function() {
  ...
  describe('search', function() {
    ...
    context('search phrases', function() {
      before(function() {
        db.index('John, John. I think, John and Chris are going shopping today');
      ...
      it('searches phrases', function() {
        expect(db.search('go')).to.have.members([
          'John, John. I think, John and Chris are going shopping today',
        ...
        expect(db.search('chris shop')).to.deep.eq([
          'John, John. I think, John and Chris are going shopping today',
          'No, Chris is going to watch a movie with Carl',
        ]);

        expect(db.search('mov chris')).to.deep.eq([
          'No, Chris is going to watch a movie with Carl',
          'John, John. I think, John and Chris are going shopping today',
        ]);

        expect(db.search('go jo hom')).to.deep.eq([
          'And John is going to stay at home tonight',
          'John, John. I think, John and Chris are going shopping today',
          'No, Chris is going to watch a movie with Carl'
        ]);
